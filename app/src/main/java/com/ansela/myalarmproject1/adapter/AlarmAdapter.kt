package com.ansela.myalarmproject1.adapter
...
import com.ansela.myalrmapp.adapter.AlarmDiffUtil
...
class AlarmAdapter () : RecyclerView.Adapter<AlarmAdapter.AlarmViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AlarmViewHolder, position: Int) {
        ...
        holder.view.item_date_alarm.text = alarm.time
        holder.view.item_note_alarm.text = alarm.time
